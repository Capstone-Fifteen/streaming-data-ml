...
file_name = "/home/chi/Documents/CG4002/SW1-MachineLearning/machine-learning/Testing Data/Chi-wk8(4).txt"
...
def handleDataPacket(packet):
    ...
    file_output = open(file_name, "a")
    file_output.write(datetime.now().strftime("%Y-%m-%d %H:%M:%S.%f: ") + str(decodedPacket.__dict__)+"\n")
    file_output.close()
